...
export default function HomePage() {
  return (
    <main className="min-h-screen">
      ...
      <div className="relative z-10 border-b border-slate-700 bg-slate-900/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-5xl mx-auto">
            <h1 className="text-6xl font-bold bg-gradient-to-r from-yellow-400 via-amber-300 to-orange-400 bg-clip-text text-transparent mb-6 text-center">
              The Illusion of Money
            </h1>
            <p className="text-2xl text-slate-300 text-center mb-4">
              ...
              <div className="mt-4 text-center">
                ...
                <div className="flex gap-4 justify-center">
                  <a 
                    ...
                    rel="noopener noreferrer"
                  >
                    <Button className="bg-gradient-to-r from-yellow-500 to-amber-500 text-black font-semibold hover:from-yellow-400 hover:to-amber-400">
                      Visit NWO Truth
                    </Button>
                  </a>
                  <a 
            ...
            <div className="bg-slate-800/30 rounded-lg p-6 border border-slate-700">
              <h2 className="text-2xl font-bold text-white mb-4">About This Documentary</h2>
      ...
      {/* Footer Quote */}
      <footer className="relative z-10 bg-slate-900/80 border-t border-slate-700 mt-16">
        <div className="container mx-auto px-4 py-8 text-center">
          ...
          <cite className="text-yellow-400 font-semibold">1 Timothy 6:10</cite>
