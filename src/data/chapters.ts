    ...
    sections: [
      {
        ...
        details: [
          '15th century Italy setting',
          'Catholic Church anti-usury laws in effect',
          'Money lenders prohibited from charging interest',
          'Giovanni de\' Medici found solution',
          'Called interest payments "discretions"',
          'Semantic trick maintained appearance of following Church law',
          'Unique challenge: Lending to royalty',
          'Kings could default on loans',
          'Back up refusal with military force',
          'Threat forced Medici to adapt',
          'Had to diversify investments',
          'Had to upscale operations beyond simple lending',
          'Became international bankers',
          'Operating across multiple nations',
          'Protected wealth from single monarch\'s power',
          'Money lending evolved into banking',
          '150 years: Backstreet money lenders to dominating Europe',
          'First truly international banking network',
          'Branches in major cities',
          'Could transfer wealth across borders',
          'Could transfer credit across borders',
          'Banking transcends national boundaries',
          'International operations necessary for survival',
          'When lending to those commanding armies',
          'Principles established:',
          'Semantic manipulation circumvents legal restrictions',
          'Geographic diversification avoids single control points',
          'Financial power requires operating above single nation',
          'Template for modern multinational banking'
        ]
      },
      {
        ...
        details: [
          ...
          'Features Shylock character',
          'Ruthless Jewish money lender',
          'Demands pound of flesh as collateral',
          'Question: Why make villain Jewish?',
          'Answer reveals critical historical reality',
          'Christians forbidden from charging Christians interest',
          'Church law prohibition',
          'Created vacuum in lending market',
          'Jewish lenders filled vacuum',
          'Not bound by Christian law for loans to non-Jews',
          'Religious arbitrage situation',
          'Jews could charge Christians interest legally',
          'Christians could NOT charge other Christians interest',
          'Money lending became predominantly Jewish profession',
          'In Christian Europe specifically',
          'Stereotype of "Jewish banker" origin',
          'Not from ethnic characteristics',
          'From legal restrictions channeling profession',
          'Christians needed lending services',
          'But couldn\'t provide to each other',
          'Under Church law',
          'Jews filled economic niche',
          'Created resentment',
          'Created stereotypes persisting today',
          'Shylock represented historical reality',
          'Jewish lender in Christian society',
          'Lending essential but religiously prohibited for Christians',
          'Play reveals: Religious law creates unintended consequences',
          'Concentrates professions in specific communities',
          'Etymology: "Bank" from Italian "banca"',
          'Banca = bench money changers sat on',
          'In marketplace',
          'When money changer couldn\'t pay: Bankrupt',
          '"Banca rotta" = broken bench',
          'Financial terminology preserves history'
        ]
      },
      {
        ...
        details: [
          ...
          'Revolutionary development in history',
          'First enterprise issuing shares to general public',
          'Created world\'s FIRST stock market',
          'Shares could be bought and sold',
          'Established speculative financial markets',
          'Dominate today\'s economy',
          'Unprecedented governmental powers received:',
          'Monopoly charter: ALL Asian spice trade',
          'Could wage war on competitors',
          'Could wage war on indigenous populations',
          'Could imprison convicts WITHOUT trial',
          'Could execute convicts WITHOUT trial',
          'Could negotiate treaties with foreign nations',
          'AS IF sovereign state itself',
          'Could coin OWN money',
          'Establishing own currency',
          'Could establish colonies',
          'Rule over vast territories',
          'Rule over vast populations',
          'Critical reality: Private profit-seeking corporation',
          'Had powers of sovereign nation',
          'Power to make war',
          'Power to execute people',
          'Power to create money',
          'Power to rule colonies',
          'NOT government entity',
          'Business generating shareholder returns',
          'Wielded nation-state powers',
          'Documentary observation: Like certain American corporations today',
          'Modern corporations: May not have powers officially',
          'But function with similar authority:',
          'Private military contractors',
          'Control over monetary policy through central bank influence',
          'Trade agreements superseding national laws',
          'Economic colonization of developing nations',
          'As first multinational corporation:',
          'Paid 18% annual dividend',
          'For nearly 200 years',
          'Extraordinary return from:',
          'Monopoly power',
          'Governmental authority',
          'Ruthless exploitation of colonized peoples',
          'Ruthless exploitation of resources',
          'Template established: Corporations above national sovereignty',
          'Model mega-corporations follow today:',
          'Through lobbying',
      ...
      },
      {
        ...
        details: [
          ...
          'Dutch corporate elite made fortunes',
          'East India Company and trading ventures',
          'Built elaborate estates',
          'Extensive flower gardens',
          'Tulips became fashionable',
          'Status symbols among wealthy',
          'Demand grew among elite',
          'Tulips became increasingly valuable',
          'Then: Speculation took over',
          'People buying NOT to plant in gardens',
          'Solely to resell at higher prices',
          'Speculation reached absurd heights',
          'Offers: 5 acres of land for single tulip bulb',
          'Productive agricultural land',
          'Could feed families for generations',
          'Traded for single flower bulb',
          'Would bloom for few weeks only',
          'Bubble collapsed in 3 months',
          'Peak buyers left holding bulbs',
          'Worth fraction of what they paid',
          'Sellers near top: Walked away with fortunes',
          'Fundamentally NOT about tulips',
          'About human psychology',
          'About greed and fear',
          'Driving prices beyond rational valuation',
          'Critical observation from documentary:',
          'Prices determined not just by supply and demand',
          'But by greed and fear',
          'Essence of speculative bubbles throughout history',
          'Whether tulips, stocks, dot-coms, or housing',
          'Pattern repeats',
          'Prices detach from underlying value',
          'Reflect mass psychology instead',
          'Greed to get rich quick',
          'Fear of missing out',
          'First recorded speculative bubble',
          'Certainly not the last',
          'Pattern established:',
          '1. Fashionable asset',
          '2. Rising prices attract speculators',
          '3. Prices reach absurd levels divorced from utility',
          '4. Sudden collapse destroys late buyers',
          'Repeats countless times',
          'Understanding tulip mania = understanding financial markets',
          'Not rational pricing mechanisms',
          'Emotion-driven systems',
          'Greed and fear create booms and busts',
          'Transfer wealth from many to few',
          'Who time cycle correctly'
        ]
      },
      {
        ...
        details: [
          ...
          'Most successful financial fraud in history',
          'Privately-owned central bank',
          'Disguised as government institution',
          'Template eventually replicated in virtually every nation',
          'Including United States with Federal Reserve',
          'Context: England\'s endless wars bankrupted nation',
          'Government desperate for funding',
          'Exhausted ability to borrow',
          'Government officials met with money changers',
          'Discussed solutions',
          'Money changers demanded high price:',
          'Private central bank',
          'Exclusive right to loan money to government',
          'At interest',
          'Genius/evil in the deception:',
          'Named "Bank of England"',
          'Deliberately chosen name',
          'Make people think private bank was part of government',
          'It wasn\'t',
          'Privately-owned corporation',
          'Shareholders remained largely secret',
          'Government had NO ownership stake',
          'Name suggested England\'s national bank',
          'Name suggested governmental institution',
          'Name suggested serving public interest',
          'Supposed startup capital: £1.25 million',
          'Only £750,000 actually received',
          'Bank began operations undercapitalized',
          'Yet granted extraordinary privilege:',
          'Creating money',
          'Lending it to government at interest',
          'Could create money from NOTHING',
          'Charge nation\'s taxpayers interest',
          'On fabricated debt',
          'Telling detail about power dynamic:',
          'Queen of England wants to visit City of London',
          'City of London = financial district',
          'Must receive permission from Lord Mayor',
          'Because borrower is servant to lender',
          'Even monarch asks permission',
          'To enter banking-controlled territory',
          'City of London: Different laws than rest of Britain',
          'Functions as sovereign financial state',
          'Within the nation',
          'Arrangement inverts proper relationship:',
          'Rather than government creating money',
          'Spending into circulation for public benefit',
          'Private banks create money as debt',
          'Loan to government at interest',
          'Nation immediately indebted to private interests',
          'Debt can NEVER be fully repaid',
          'Because interest required to pay back',
          'Was never created',
          'Guarantees permanent debt',
          'Guarantees permanent interest payments',
          'Flowing from taxpayers to private shareholders',
          'Template established for worldwide replication:',
          'Private central bank',
          'Official-sounding governmental name',
          'Granted monopoly power to create money',
          'Lend at interest to government',
          'Shareholders remain largely unknown',
          'Operates with special legal privileges',
          'Nation becomes permanently indebted to private interests',
          'Transfers wealth from productive population',
          'To financial elites',
          'Through perpetual interest payments',
          'On money created from nothing'
        ]
      },
      {
        ...
        details: [
          'John Law: Scottish gambler',
          'Convicted murderer',
          'Fled Britain to escape execution',
          'Through charm and mathematical ability',
          'Convinced French government',
          'Let him implement monetary theories',
          'On national scale',
          'Established Bank General in France',
          'Created Mississippi Company',
          'Claimed to own vast Louisiana territories',
          'Painted Louisiana swampland',
          'As agricultural paradise',
          'Rich with resources and opportunities',
          'Shares sold to public',
          'Based on fraudulent claims',
          'Used newly printed paper money from his bank',
          'To inflate share prices',
          'Prices rose: 500 to 15,000 livres',
          '30-fold increase',
          'Based ENTIRELY on speculation',
          'Based on false promises',
          'Scheme integrated with government:',
          'Could literally walk',
          'From share-issuing office',
          'To money-printing office',
          'In same building',
          'Printing money to buy shares',
          'Of own company',
          'Driving up prices',
          'Then selling shares to public',
          'For inflated prices',
          'Documentary observation:',
          '"In effect, a con man was prime minister of France"',
          'Law achieved such influence',
          'Essentially controlled French economic policy',
          'Demonstrates: Governments easily captured',
          'By financial fraudsters',
          'Who promise easy fiscal solutions',
          'Mississippi Bubble inevitably collapsed',
          'Destroyed savings of thousands',
          'Severely damaged France\'s economy',
          'Yet lesson never learned',
          'Documentary notes:',
          '"Real wealth earned from making a living"',
          '"Speculation doesn\'t create wealth"',
          '"Speculation transfers wealth"',
          'Based on greed and fear',
          '"This lesson is never learned"',
          'Episode reveals enduring truths:',
          'Desperate governments accept fraudulent schemes',
          'From charismatic promoters',
          'Paper money allows unprecedented fraud',
          'Through inflation',
          'Speculation transfers rather than creates wealth',
          'Masses never learn',
          'Get-rich-quick schemes end in collapse',
          'Early insiders profit',
          'At expense of late entrants'
        ]
      }
    ],
    keyFigures: [
    ...
    sections: [
      {
        ...
        details: [
          'American Revolution fundamentally about money',
          'Not just "taxation without representation"',
          'Founding fathers saw Bank of England running up British debt',
          'Unfair taxes on colonies to service that debt',
          'Before Revolution: 13 colonies printed own paper currency',
          'Used gold/silver coins too',
          'Not enough metallic money for commerce to flow',
          '1764: British Currency Act passed',
          'Prohibited colonial currency issuance',
          'Ordered all taxes paid in gold/silver coins ONLY',
          'Devastating effect on colonies',
          'Systematically drained of metallic money',
          'Any other currency form outlawed',
          'Colonies rebelled out of desperation',
          'Printed Continental Dollar',
          'Grabbed guns and fought',
          'During war: British counterfeiting as weapon',
          'British agents flooded colonies with printed continentals',
          'Deliberately destroyed American currency value',
          'America won militarily',
          'America lost financially',
          'Continental Dollar destroyed',
          'Briefly forced to use Bank of North America',
          'Bank shut down after short time'
        ]
      },
      {
        ...
        details: [
          'Bank of England was big, Rothschilds FAR bigger',
          'Came to OWN Bank of England',
          'Greatest financial coup: Battle of Waterloo',
          '1905 Jewish Encyclopedia: FIVE layers of profit',
          '1st: Sale of Wellington\'s Bank of England bonds (war funds)',
          '2nd: Sale of gold to Wellington\'s armies',
          '3rd: Repurchase of gold from Wellington after war',
          '4th: Forwarding that gold to Portugal',
          '5th (ESPECIALLY): Purchase of Bank of England bonds for pennies',
          'Nathan Rothschild spread false Napoleon victory rumor',
          'Crashed bond prices',
          'Truth of Wellington victory emerged',
          'Rothschilds bought massive bonds at bottom',
          'Above market prices AND national laws',
          'If gold higher in Paris: James sells, Nathan buys in London',
          'Financed Cecil Rhodes: South African gold monopoly',
          'Financed De Beers: South African diamond monopoly',
          'Financed Rockefeller: American oil monopoly',
          'Financed JP Morgan: American steel monopoly',
          'If nation\'s policies hindered interests: Transfer capital',
          'Or finance overthrow of governments',
          'Jacob Schiff (NY base): Financed communist overthrow of Russian Tsar',
          'Tsar had opposed Rothschild interests',
          'First true multinational banking operation',
          'So rich: Owned 41 elaborate castles across Europe',
          '1817-1848: Loaned over $654 million',
          'Adjusted for inflation: Like loaning TRILLIONS today'
        ]
      },
      {
        ...
        details: [
          ...
          'Volume 1 documented: War about breaking up America',
          'Purpose: Easier banker control of divided nation',
          'Abraham Lincoln invented the greenback',
          'Printed currency',
          'Would later be backed by gold',
          'Kept Union alive',
          'Without succumbing to banker demands',
          'Bankers wanted high-interest war loans',
          'Direct threat to international banking interests',
          'They profit from lending to governments at interest',
          'Historians argue: Debt-free currency major assassination factor',
          'Bankers wanted to control America through debt',
          'Denied opportunity while Lincoln could print greenbacks',
          'Union won Civil War',
          'But bankers didn\'t give up',
          'Goal remained: Monetary control over America'
        ]
      },
      {
        ...
        details: [
          'Following Civil War: Bankers implemented legislative attack',
          'Purpose: Contract American money supply and assert control',
          'Coinage Act of 1873: "Crime of \'73"',
          'Demonetized silver',
          'Ended tradition of free silver coinage',
          'Western miners could no longer take silver to US Mint',
          'Specie Payment Resumption Act of 1875',
          'Allowed convertibility of greenbacks into gold',
          'These TWO acts working together',
          'Systematically contracted American money supply',
          'Created the Long Depression',
          'By 1896: Silver money need became KEY presidential issue',
          'Silver plentiful in America',
          'NOT controlled by international bankers',
          'William Jennings Bryan\'s famous speech',
          '"Crown of thorns" on labor',
          '"Crucify mankind on cross of gold"',
          'Speaking against banker-controlled gold standard',
          'Favored silver-backed currency',
          'Would expand money supply',
          'Help working people',
          'William McKinley won presidency',
          'The fix was in',
          'Bankers wanted America on gold standard',
          'They controlled gold through vast holdings',
          'International gold connections',
          'McKinley victory ensured gold standard formalization',
          'Monetary control stayed with gold controllers'
        ]
      },
      {
        ...
        details: [
          'JP Morgan inherited wealth from father',
          'Father\'s fortune: Treasonous business with Rothschilds',
          'Through George Peabody during Civil War',
          'JP Morgan continued family treason tradition',
          'Worked with Rothschild agent August Belmont Jr.',
          'Manipulated American markets for foreign banking',
          'Panic of 1893: Created BY DESIGN',
          'Morgan and Belmont coordinated',
          'Arranged vast US government bond holdings sold',
          'Through third parties (hide involvement)',
          'Exclusively for GOLD not silver',
          'Created banking panic',
          'People rushed to convert holdings to gold',
          'Mass dumping of US treasuries',
          'Gold flowed from America to London',
          'London banks demanded gold as loan security',
          'Impossible for American banks to get gold',
          'Due to orchestrated panic',
          'Morgan stepped forward "patriotically"',
          'Bought $162 million bonds at sweetheart prices',
          'Used gold at artificially inflated prices',
          'He and associates controlled gold prices',
          'Result devastating: 15,000 businesses FAILED',
          '74 railroads went bankrupt',
          '600 banks collapsed',
          'JP Morgan bought everything at fire-sale prices',
          'Succeeded in crushing American silver\'s financial role',
          'Silver was plentiful in America',
          'Gold Standard Act of 1900 passed',
          'Formalized banker control over American currency',
          'Dump-and-pump strategy repeated',
          'Crash markets to buy cheap',
          'Inflate them to sell high',
          'Eventually controlled US Steel',
          '1901: US Steel valued at $1.4 BILLION',
          'World\'s first billion-dollar corporation',
          'Gave Morgan unprecedented control over American industry'
        ]
      },
      {
        ...
        details: [
          'JD Rockefeller: One of six children',
          'Parents: William Rockefeller Sr. and Eliza Davidson',
          'Background crucial to understanding later ruthlessness',
          'William Rockefeller Sr.: HUCKSTER all his life',
          'Traveling con man',
          'Sold bottles of crude oil',
          'Claimed miracle cure-all medicine',
          'Abandoned Eliza and 6 children',
          'Left for series of other women',
          'Eliza left to raise family ALONE',
          'In poverty',
          'When young JD misbehaved:',
          'Eliza would TIE him up',
          'BEAT him until he complied',
          'Tragic and abusive childhood',
          'Explains obsessive desire to manipulate and control',
          'All business relationships about control',
          'Publicly: Appeared as devout Christian philanthropist',
          'Attended church regularly',
          'Gave to charity',
          'Meanwhile: Most ruthless businessman in American history',
          'Standard Oil growth from 1870',
          'Built on integration and extortion',
          'Developed railroad scheme:',
          'Railroads transporting Standard Oil',
          'Had to pay percentage of COMPETITORS\' shipping fees',
          'Back to Standard Oil',
          'OR Standard Oil would drop railroad\'s business',
          'Every time competitor shipped oil by rail',
          'They were funding Rockefeller\'s operations',
          'Competitors paying for own destruction',
          'Horizontal integration: Buying out competitors',
          'Vertical integration: Control drilling to distribution',
          'Built empire',
          'Became America\'s FIRST BILLIONAIRE',
          'Wealth built on: Childhood trauma',
          'False Christian piety',
          'Economic warfare against all competition'
        ]
      },
      {
        ...
        details: [
          '1901: Pivotal moment in American financial history',
          'Banking interests of JP Morgan',
          'Merged with oil business of JD Rockefeller',
          'Plus top railroad company owners',
          'Created Northern Securities Company',
          '122 companies agreed to pool capital',
          'Total pooled capital: $22 BILLION (1901 dollars)',
          'In perspective: Worth hundreds of billions to trillions today',
          'Unprecedented concentration of economic power',
          'Sherman Antitrust Act: Used to dissolve Northern Securities',
          'Dissolved in 1904',
          'Reason: Illegal monopoly',
          'Threatened competition and democracy itself',
          'HOWEVER: While legal structure dissolved',
          'Capital NEVER disappeared',
          'Same banking and business class',
          'Simply reorganized control through other means',
          'Tasted power of combination and coordination',
          'Wanted it ALL:',
          'Complete control over banking',
          'Complete control over industry',
          'Complete control over transportation',
          'Ultimately: Complete control over currency itself',
          'Dissolution of Northern Securities = temporary setback',
          'Road to Federal Reserve establishment 1913',
          'Would give same interests permanent control',
          'Over America\'s money supply'
        ]
      }
    ],
    keyFigures: [
